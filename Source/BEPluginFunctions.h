...
FMX_PROC(fmx::errcode) BE_File_Modification_Timestamp ( short funcId, const fmx::ExprEnv& environment, const fmx::DataVect& data_vect, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_ContainerCompress ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
FMX_PROC(fmx::errcode) BE_ContainerUncompress ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_HTTP_GET ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
FMX_PROC(fmx::errcode) BE_HTTP_GET_File ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
FMX_PROC(fmx::errcode) BE_HTTP_POST_PUT_PATCH ( short funcId, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_FTP_Upload ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_FTP_Delete ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
FMX_PROC(fmx::errcode) BE_HTTP_Get_Response_Header ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_Values_Trim ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
...
FMX_PROC(fmx::errcode) BE_Get_Machine_Name ( short /* funcId */, const fmx::ExprEnv& /* environment */, const fmx::DataVect& parameters, fmx::Data& results );
