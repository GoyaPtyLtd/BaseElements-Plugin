...
unsigned long Sub_LinuxLoadString ( const unsigned long string_id, FMX_Unichar * intoHere, const long intoHereMax )
{
	...
	strings [ kBE_StripInvalidUTF16CharactersFromXMLFile ] = "BE_StripInvalidUTF16CharactersFromXMLFile ( path )";
	strings [ kBE_MoveFile ] = "BE_MoveFile ( from ; to )";
	strings [ kBE_CopyFile ] = "BE_CopyFile ( from ; to )";
	strings [ kBE_ListFilesInFolder ] = "BE_ListFilesInFolder ( path {; type ; includeSubdirectories ; useFullPath } )";
	...
	strings [ kBE_MessageDigest ] = "BE_MessageDigest ( text {; algorithm ; encoding } )";
	...
	strings [ kBE_Base64_Decode ] = "BE_Base64_Decode ( text {; name } )";
	strings [ kBE_Base64_Encode ] = "BE_Base64_Encode ( data )";
	...
	strings [ kBE_HTTP_Response_Headers ] = "BE_HTTP_Response_Headers";
	...
	strings [ kBE_JPEG_Recompress_Depreciated ] = "BE_JPEG_Recompress_Depreciated ( jpeg {; compressionLevel ; width ; height } )";
	strings [ kBE_JPEG_Recompress ] = "BE_JPEG_Recompress ( jpeg {; compressionLevel ; scale } )";
	strings [ kBE_JSONPath ] = "BE_JSONPath ( json ; path )";
	strings [ kBE_JSON_Error_Description ] = "BE_JSON_Error_Description";
	strings [ kBE_JSON_ArraySize ] = "BE_JSON_ArraySize ( json )";
	strings [ kBE_JSON_Encode ] = "BE_JSON_Encode ( key {; value ; type } )";
	...
	strings [ 2001 ] = "BE_MessageDigestAlgorithm_MD5";
	strings [ 2002 ] = "BE_MessageDigestAlgorithm_SHA256";
	strings [ 2003 ] = "BE_MessageDigestAlgorithm_MDC2";
	strings [ 2004 ] = "BE_MessageDigestAlgorithm_SHA";
	strings [ 2005 ] = "BE_MessageDigestAlgorithm_SHA1";
	strings [ 2006 ] = "BE_MessageDigestAlgorithm_SHA224";
	strings [ 2007 ] = "BE_MessageDigestAlgorithm_SHA384";
	strings [ 2008 ] = "BE_MessageDigestAlgorithm_SHA512";
