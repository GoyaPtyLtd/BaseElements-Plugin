/*
 ...
 Copyright 2015-2020 Goya. All rights reserved.
...
#define	AUTO_UPDATE_VERSION "04010403"
#define VERSION_NUMBER_STRING "4.1.4" // e.g. 4.0.1
#define VERSION_STRING "4.1.4"	// e.g. 4.0.1b2
