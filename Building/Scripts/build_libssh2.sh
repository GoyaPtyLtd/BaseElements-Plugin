...
BUILD_DIR=$HOME/Downloads/libssh2_iOS_Release # RELEASE_DIR
mkdir -p ${BUILD_DIR}
cd $BUILD_DIR
cd "../libssh2-1.9.0"
...
make clean
make
cp src/.libs/libssh2.a "${BUILD_DIR}/libssh2-${ARCH}.a"
build_one="$ARCH"
...
lipo -create "${BUILD_DIR}/libssh2-arm64.a" "${BUILD_DIR}/libssh2-x86_64.a" -output "${BUILD_DIR}/libssh2.a"
lipolog="$(lipo -info ${BUILD_DIR}/libssh2.a)"
