...
// building the macOS version will automatically set the version information for windows

#define	AUTO_UPDATE_VERSION "04019900"
#define VERSION_NUMBER_STRING "4.2.0" // e.g. 4.0.1
#define VERSION_STRING "4.2b1"	// e.g. 4.0.1b2
